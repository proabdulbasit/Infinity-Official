...
const [business] = 
['price_1PMPmmIaDopbLhfRITuzI8HW'];

admin.initializeApp({
  credential: admin.credential.cert(serviceAccount),
  databaseURL: "https://infinity-c494a-default-rtdb.firebaseio.com"
});
...
app.post("/api/v1/create-subscription-checkout-session", async(req, res) => {
    ...
    let planId = null;
    if(plan == 200) planId = business;
    else if(plan == 300) planId = healthcare;
